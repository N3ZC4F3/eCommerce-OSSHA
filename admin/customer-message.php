				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Seleccionar un Cliente <span>*</span></label>
							<div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Ver todos los mensajes de los clientes</h1>
	</div>
</section>
				...
				<div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th width="30">#</th>
								<th width="100">Sujeto</th>
								<th width="200">Mensaje</th>
								<th width="200">Detalles del pedido</th>
							</tr>
						</thead>
						<tbody>
							<?php
