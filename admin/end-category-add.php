...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "El nombre de la categoría del nivel final no puede estar vacío<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'La categoría de nivel final se agregó correctamente.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Agregar categoría de nivel final</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category.php" class="btn btn-primary btn-sm">Ver Todos</a>
	</div>
</section>
