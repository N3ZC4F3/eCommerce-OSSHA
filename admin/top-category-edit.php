...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'El nombre de la categoría superior ya existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La categoría superior se actualizó correctamente.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar categoría de nivel superior</h1>
	</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="show_on_menu" class="form-control" style="width:auto;">
                            ...
                            <option value="1" <?php if($show_on_menu == 1) {echo 'selected';} ?>>Sí</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
