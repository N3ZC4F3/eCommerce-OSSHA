			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Precio actual <span>*</span><br><span style="font-size:10px;font-weight:normal;">(En USD)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Foto destacada existente</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Cambiar foto destacada </label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">¿Está activo?</label>
							<div class="col-sm-8">
