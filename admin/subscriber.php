...
<section class="content-header">
	...
	<div class="content-header-right">
		...
		<a href="subscriber-csv.php" class="btn btn-primary btn-sm">Exportar como CSV</a>
	</div>
</section>
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td><a href="#" class="btn btn-danger btn-xs" data-href="subscriber-delete.php?id=<?php echo $row['subs_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Borrar</a></td>
	                </tr>
            		<?php
            	}
            	?>
