...
<html>
  <head>
    ...
    <title>AdminLTE 2 | Panel de Control</title>
                    ...
                    <ul class="menu">
                      <li>
                        ...
                        <a href="#">
                          ...
                          <p>¿Por qué no comprar un producto nuevo e increíble?</p>
                        </a>
                      </li>
                      <!-- end message -->
                      <li>
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <a href="pages/UI/icons.html"
                    ><i class="fa fa-circle-o"></i> Iconos</a
                  >
                </li>
                <li>
                  <a href="pages/UI/buttons.html"
                    ><i class="fa fa-circle-o"></i> Botones</a
                  >
                </li>
                <li>
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <a href="pages/examples/login.html"
                    ><i class="fa fa-circle-o"></i> Iniciar Seción</a
                  >
                </li>
                <li>
                  <a href="pages/examples/register.html"
                    ><i class="fa fa-circle-o"></i> Registrarse</a
                  >
                </li>
                <li>
