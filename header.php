...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="assets/img/Logo-OSSHA.png">
	<!--<link rel="icon" type="image/png" href="images/Logo-OSSHA.png">-->
	...
	if($cur_page == 'index.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		...
		<meta name="Palabras clave" content="<?php echo $meta_keyword_home; ?>">
	...
	if($cur_page == 'dashboard.php') {
		?>
		<title>Panel de Control - <?php echo $meta_title_home; ?></title>
		<meta name="Palabras Clave" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-profile-update.php') {
		?>
		<title>Actualizar Perfil - <?php echo $meta_title_home; ?></title>
	...
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Actualizar Dirección de Pago y Envío - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-password-update.php') {
		?>
		<title>Actualizar Contraseña - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
