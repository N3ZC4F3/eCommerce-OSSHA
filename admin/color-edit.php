...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['color_name'])) {
        $valid = 0;
        $error_message .= "El nombre del color no puede estar vacío<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'El nombre del color ya existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'El color se actualizó correctamente.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="color.php" class="btn btn-primary btn-sm">Ver Todo</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nombre del color <span>*</span></label>
                    <div class="col-sm-4">
