...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$success_message = '¡Las preguntas frecuentes se agregaron correctamente!';
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Agregar preguntas frecuentes</h1>
	</div>
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Ver Todo</a>
	</div>
</section>
