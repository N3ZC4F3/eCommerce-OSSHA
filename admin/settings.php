...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Favicon se actualizó correctamente.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'El título del último producto no puede estar vacío<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo del último producto no puede estar vacío<br>';
    }
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Icono</a></li>
                        ...
                        <li><a href="#tab_9" data-toggle="tab">Configuración de pago</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Guiones de cabeza y cuerpo</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Actualizar logotipo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Actualizar Icono</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Sección de boletín </label>
                                        <div class="col-sm-3">
                                            <select name="newsletter_on_off" class="form-control" style="width:auto;">
                                                <option value="1" <?php if($newsletter_on_off == 1) {echo 'selected';} ?>>Encendido</option>
                                                <option value="0" <?php if($newsletter_on_off == 0) {echo 'selected';} ?>>Apagado</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Pie de página - Derechos de autor </label>
                                        <div class="col-sm-9">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contacto Mapa iFrame </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Correo electrónico de contacto</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Mensaje de Olvidé mi contraseña</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>Secciones Activado y desactivado</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección de Servicio </label>
                                        <div class="col-sm-4">
                                            <select name="home_service_on_off" class="form-control" style="width:auto;">
                                            	...
                                            	<option value="0" <?php if($home_service_on_off == 0) {echo 'selected';} ?>>Desactivado</option>
                                            </select>
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección de bienvenida </label>
                                        <div class="col-sm-4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Metapalabra clave </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="meta_keyword_home" style="height:100px;"><?php echo $meta_keyword_home ?></textarea>
                                        </div>
                                    </div>  
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Metadescripción </label>
                                        <div class="col-sm-8">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Título de producto popular<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_1">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_2">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_3">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_4">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_6">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_7">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Cambiar banner de página de pago</h4>
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_8">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Seleccione Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_9">
                                    </td>
                                    </form>
                                </tr>
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">PayPal - Correo electrónico comercial </label>
                                            <div class="col-sm-5">
                                      ...
                                      <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Información bancaria </label>
                                            <div class="col-sm-5">
                        ...
                        <div class="tab-pane" id="tab_10">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Código antes &lt;/head&gt; tag </label>
                                            <div class="col-sm-8">
                                                <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Código después &lt;body&gt; tag </label>
                                            <div class="col-sm-8">
                                                <textarea name="after_body" class="form-control" cols="30" rows="10"><?php echo $after_body; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Código antes &lt;/body&gt; tag </label>
                                            <div class="col-sm-8">
