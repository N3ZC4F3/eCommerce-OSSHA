	...
	<script>
	  $(function () {
	    ...
	    {
	        return confirm("¿Estás seguro que deseas eliminar estos datos?");
	    }
	    function confirmActive()
	    {
	        return confirm("¿Estás seguro que quieres activarlo?");
	    }
	    function confirmInactive()
	    {
	        return confirm("¿Estás seguro que quieres inactivarlo?");
	    }
