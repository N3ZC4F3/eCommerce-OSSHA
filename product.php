...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = '¡Lo siento! Solo hay '.$current_p_qty.' artículo(s) en el depósito';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Este producto ya está añadido al carrito de compras.';
        } else {
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <div class="form-group">
                                                <textarea name="comment" class="form-control" cols="30" rows="10" placeholder="Escribe tu comentario (opcional)" style="height:100px;"></textarea>
                                            </div>
