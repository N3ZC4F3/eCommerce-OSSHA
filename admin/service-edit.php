...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = '¡El servicio se actualizó exitosamente!';
	}
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="service.php" class="btn btn-primary btn-sm">Ver Todo</a>
	</div>
</section>
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(Sólo se permiten jpg, jpeg, gif y png)
							</div>
						</div>	
						<div class="form-group">
