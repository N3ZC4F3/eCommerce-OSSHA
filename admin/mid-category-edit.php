...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "El nombre de la categoría de nivel medio no puede estar vacío<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La categoría de nivel medio se actualizó correctamente.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar categoría de nivel medio</h1>
	</div>
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Ver todo</a>
	</div>
</section>
