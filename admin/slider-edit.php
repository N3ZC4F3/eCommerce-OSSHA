...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = '¡El control deslizante se actualizó correctamente!';
	}
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar control deslizante</h1>
	</div>
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Ver todo</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Botón de texto </label>
							<div class="col-sm-6">
