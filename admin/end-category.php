    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">¡Ten cuidado! Todos los productos de esta categoría final se eliminarán de todas las tablas, como la tabla de pedidos, la tabla de pagos, la tabla de tallas, la tabla de colores, la tabla de clasificaciones, etc.</p>
            </div>
