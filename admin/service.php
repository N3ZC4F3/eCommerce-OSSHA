...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="service-add.php" class="btn btn-primary btn-sm">Agregar servicio</a>
	</div>
</section>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="#" class="btn btn-danger btn-xs" data-href="service-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Borrar</a>  
									</td>
								</tr>
								<?php
							}
