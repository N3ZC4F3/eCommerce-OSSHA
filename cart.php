...
if(isset($_POST['form1'])) {
    ...
    $error_message .= '\¡La cantidad de OTROS artículos se actualizó correctamente!';
    ?>
    
    <?php if($allow_update == 0): ?>
    	<script>alert('<?php echo $error_message; ?>');</script>
	<?php else: ?>
		<script>alert('¡La actualización de la cantidad de todos los artículos ha sido exitosa!');</script>
	<?php endif; ?>
    <?php
