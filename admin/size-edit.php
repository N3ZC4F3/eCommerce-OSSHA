...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "El nombre del tamaño no puede estar vacío.<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'El nombre del tamaño ya existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'El tamaño se actualizó correctamente.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="size.php" class="btn btn-primary btn-sm">Ver todo</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nombre del tamaño <span>*</span></label>
                    <div class="col-sm-4">
