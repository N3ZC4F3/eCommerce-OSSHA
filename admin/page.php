...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La información de la página de preguntas frecuentes se actualizó correctamente.';
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Preguntas Frecuentes</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Contacto</a></li>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Título de la página * </label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="about_title" value="<?php echo $about_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contenido de página * </label>
                                        <div class="col-sm-8">
