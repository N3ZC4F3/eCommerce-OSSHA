...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "El nombre del país no puede estar vacío<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "El nombre del país ya existe<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'El país se agregó correctamente.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="country.php" class="btn btn-primary btn-sm">Ver Todos</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nombre del País <span>*</span></label>
							<div class="col-sm-4">
