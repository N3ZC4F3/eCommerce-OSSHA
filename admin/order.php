...
';
        ...
        $success_message = 'Su correo electrónico al cliente se envió correctamente.';
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo ', <b>Unit Precio:</b> '.$row1['unit_price'].')';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        <td>
                        	<?php if($row['payment_method'] == 'PayPal'): ?>
                        		...
                        		<b>Identificación de pago:</b> <?php echo $row['payment_id']; ?><br>
