...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['caption'])) {
        $valid = 0;
        $error_message .= "El nombre del pie de foto no puede estar vacío<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'La foto se actualizó correctamente.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Pie de foto <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Subir nueva foto <span>*</span></label>
